        ...
        <div className={styles.knowledges}>
            ...
            <div className={styles.list}>
                <label htmlFor="novice">
                    <input type="radio" id="novice" value="novice" name="knowledges-lvl"/>
                    Novice
                </label>
                <label htmlFor="medium">
                    <input type="radio" id="medium" value="intermediaire" name="knowledges-lvl"/>
                    Intermediaire
                </label>
                <label htmlFor="expert">
                    <input type="radio" id="expert" value="expert" name="knowledges-lvl"/>
                    Expert
                </label>
            </div>
