...
export const NavigationButtons: React.FC<{
    ...
    return (
        <div className={styles.navigateButtons}>
            <button type="button" value="previous" className={hideFirst ? styles.hide : ''} disabled={hideFirst}
                    onClick={handleClickPrevious}/>
            <button type="button" value="next" className={hideLast ? styles.hide : ''} disabled={hideLast}
